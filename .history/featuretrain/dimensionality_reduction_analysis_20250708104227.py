...
class DimensionalityReductionAnalyzer:
    ...
    def run_analysis(self, sample_size=2000):
        """运行完整的降维分析"""
        print("🎯 降维可视化分析")
        print("=" * 60)
        ...
        # 2. 准备合并数据
        features, labels, colors, color_map = self.prepare_combined_data(sample_size)
...
def main():
    ...
    success = analyzer.run_analysis(sample_size=2000)  # 每组采样2000个样本
