...
class DataExplorer:
    ...
    def feature_distribution_analysis(self):
        ...
        for i, feature in enumerate(top_features):
            ...
            # 绘制直方图
            ax.hist(white_vals, bins=30, alpha=0.6, label='白样本', color='blue', density=True)
            ax.hist(black_vals, bins=30, alpha=0.6, label='黑样本', color='red', density=True)
            ax.hist(misc_vals, bins=20, alpha=0.8, label='误报样本', color='orange', density=True)
